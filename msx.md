...
3. For each teammembership, get the "Deal Team", "Opportunity", and "Account" it corresponds to, all in one!
    - `https://microsoftsales.crm.dynamics.com/api/data/v9.2/teams(ea1e1a3a-cc12-f111-8406-002248299577)?$expand=regardingobjectid_opportunity($select=name;$expand=parentaccountid($select=accountid,name))`
    - That above will:
    - Pull down that team.
